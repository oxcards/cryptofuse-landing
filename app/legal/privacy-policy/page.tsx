      ...
      <div className="container mx-auto px-4 py-24 md:py-28 max-w-3xl">
        ...
        <div className="prose dark:prose-invert max-w-none">
          <p className="text-lg mb-4">
            This Privacy Policy explains how CryptoFuse collects, uses, and shares your personal information when you use our services.
          </p>

          <p>
            Content of the privacy policy page will go here.
          </p>
        </div>
